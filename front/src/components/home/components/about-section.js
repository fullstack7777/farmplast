        ...
        <div id="section2" style={{paddingBottom: 60}}>
            ...
            <Container>
                ...
                <div className="custom-colored-text">
                    ...
                    <p> ООО "Фармпласт" является <span className="custom-bold">дистрибьютором</span>  ПАО "Сибур Холдинг", ПАО "Нижнекамскнефтехим", ПАО "Казаньоргсинтез". </p>
                    ...
                    <ul>
                        ...
                        <li><FontAwesomeIcon icon={faStop} color={'#008DA9'} style={{marginRight:'5px'}} />Оказание профессиональных консультационных практических услуг на базе Сибур ПОЛИЛАБ;</li>
                    </ul>
                </div>
            </Container>
        </div>
